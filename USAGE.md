...
> **Complete usage examples для всех модулей ML Common package**
...
# Advanced usage с multiple indicators
...
# Sample data с potential issues
prices = np.array([100, 105, 0, 110, np.inf, 95, 108])  # Contains 0 и inf
...
print(f"Processed {len(results)} chunks в parallel")
...
indicator_config = IndicatorConfig(
    ...
    parallel_calculation=False,  # Disable для small datasets
...
# Robust calculation с error handling
def safe_calculate_indicators(prices, indicators_list):
    """Safely calculate indicators с error handling"""
    try:
...
### Integration с Existing Trading System

```python
# Example integration с crypto trading bot
from ml_common.indicators import TechnicalIndicators
from ml_common.evaluation import backtest_strategy, BaseStrategy
import pandas as pd

class MLEnhancedStrategy(BaseStrategy):
    """Trading strategy enhanced с ML Common indicators"""
...
**Context7 Enterprise Architecture • Production-Ready • High-Performance**
