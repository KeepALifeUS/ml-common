"""
Test Suite для Technical Indicators Module

Comprehensive tests для all technical indicators с performance validation,
edge cases, и accuracy verification against known values.
"""
...
class TestTechnicalIndicatorsFunctions:
    ...
    def test_calculate_rsi_all_down_trend(self):
        """Test RSI с only decreasing prices"""
    ...
    def test_calculate_bollinger_bands_zero_std(self):
        """Test Bollinger Bands с constant prices (zero std)"""
        prices = [100.0] * 30
        result = calculate_bollinger_bands(prices, period=20, std_dev=2.0)
    ...
    def test_calculate_stochastic_insufficient_data(self):
        """Test Stochastic с insufficient data"""
        high = [110, 112]
        low = [100, 102]
        close = [105, 107]
...
class TestTechnicalIndicatorsClass:
    ...
    def test_initialization_with_config(self):
        """Test initialization с custom config"""
    ...
    def test_calculate_with_volume_data(self):
        """Test calculating с volume data"""
    ...
    def test_calculate_performance_single(self):
        """Test calculation performance для single indicator"""
        ti = TechnicalIndicators(["sma_20"])
        prices = generate_price_data(1000)

        result = assert_performance_acceptable(
            ti.calculate, (prices,), 5.0  # 5ms threshold для single indicator
        )

        assert "sma_20" in result

    def test_calculate_performance_multiple(self):
        """Test calculation performance для multiple indicators"""
        indicators = ["sma_20", "ema_12", "rsi_14", "macd"]
        ti = TechnicalIndicators(indicators)
        prices = generate_price_data(1000)

        result = assert_performance_acceptable(
            ti.calculate, (prices,), 15.0  # 15ms threshold для multiple indicators
        )
...
class TestIndicatorEdgeCases:
    """Test edge cases и error conditions"""
    ...
    def test_nan_input_handling(self):
        ...
        # Result might be NaN или calculated ignoring NaN
...
class TestIndicatorAccuracy:
    ...
    def test_bollinger_bands_properties(self):
        ...
        # Should be reasonably close (allowing для calculation differences)
