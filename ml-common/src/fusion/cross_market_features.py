...
and correlations between different symbols. Based on Context7 pandas
            ...
            if spot_key in spot_data and futures_key in futures_data:
                ...
                if 'close' in spot_df.columns and 'close' in futures_df.columns:
                    ...
                    if min_len >= self.min_periods:
                        ...
                        # Rolling correlation with min_periods (Context7 best practice)
...
def test_cross_market_features():
    ...
    print("\nBased on Context7 pandas & scipy best practices")
