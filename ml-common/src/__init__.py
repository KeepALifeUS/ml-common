...
Enterprise-grade consolidated ML utilities implementing Context7 patterns.
...
# Core imports для удобства использования
...
logger.info(f"ML Common v{__version__} initialized - Context7 Enterprise ML Utilities")

# Optional: Setup monitoring если включено
if os.getenv("ML_COMMON_ENABLE_MONITORING", "false").lower() == "true":
    try:
        from .utils.monitoring import setup_monitoring
        setup_monitoring()
        logger.info("Monitoring enabled для ML Common")
    except ImportError:
