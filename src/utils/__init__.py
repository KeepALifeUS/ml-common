"""
Utilities Module для ML Common

High-performance utility functions implementing Context7 patterns.
Common mathematical и data processing utilities used across ML packages.

Available modules:
- math_utils: Mathematical utility functions
- time_series: Time series processing utilities
- data_loader: Data loading и validation utilities
"""
